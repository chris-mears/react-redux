...
describe('StackForm', () => {
    ...
    it('redners a button to add a new card', () => {
        expect(stackForm.find('Button').at(0).props().children).toEqual('Add Card');
    });

    it('redners a button to submit the form', () => {
    ...
    describe('when adding a new card', () => {
        ...
        describe('and updating the card prompt', () => {
           beforeEach(() => {
               stackForm.find('FormControl').at(1).simulate('change', { target: { value: changePrompt, name: 'prompt' }});
           });
        ...
        describe('and updating the card answer', () => {
            beforeEach(() => {
                stackForm.find('FormControl').at(2).simulate('change', { target: { value: changeAnswer, name: 'answer' }});
            });
